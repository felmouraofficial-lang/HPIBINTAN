...
export default async function ContactPage() {
  const [savedContact, settings] = await Promise.all([prisma.contact.findFirst().catch(() => null), prisma.websiteSetting.findFirst().catch(() => null)]);
  const contact = savedContact ?? fallbackContact;
