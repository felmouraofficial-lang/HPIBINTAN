...
async function main() {
  ...
  if ((await prisma.member.count()) === 0) {
    await prisma.member.createMany({ data: [
      ["Ardiansyah Putra", "Ketua DPD", "+62 812-4500-1101"], ["Maya Sari", "Wakil Ketua", "+62 812-4500-1102"], ["Rizal Maulana", "Sekretaris", "+62 812-4500-1103"], ["Dewi Lestari", "Bendahara", "+62 812-4500-1104"], ["Fahmi Ramadhan", "Koordinator Lapangan", "+62 812-4500-1105"], ["Nadia Prameswari", "Koordinator Pelatihan", "+62 812-4500-1106"], ["Bima Saputra", "Pramuwisata", "+62 812-4500-1107"], ["Siti Nurhaliza", "Pramuwisata", "+62 812-4500-1108"]
