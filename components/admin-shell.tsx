...
import { LayoutDashboard, Users, CalendarCheck, Images, FileText, Bus, Megaphone, Contact, Home, Building2 } from "lucide-react";

const items = [["Dashboard", "/admin/dashboard", LayoutDashboard], ["Beranda/Tentang", "/admin/content", Home], ["Anggota", "/admin/members", Users], ["Absensi Harian", "/admin/attendance", CalendarCheck], ["Absensi Rapat", "/admin/meetings", Building2], ["Galeri", "/admin/gallery", Images], ["Dokumentasi", "/admin/documents", FileText], ["Transportasi", "/admin/transportation", Bus], ["Pengumuman", "/admin/announcements", Megaphone], ["Kontak", "/admin/contact", Contact]];
