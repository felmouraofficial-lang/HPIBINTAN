...
import { LayoutDashboard, Users, CalendarCheck, Images, FileText, Bus, Megaphone, Contact, Home, Building2, MapPinned, Settings2, FolderOpen } from "lucide-react";

const items = [["Dashboard", "/admin/dashboard", LayoutDashboard], ["Beranda/Tentang", "/admin/content", Home], ["Destinasi", "/admin/destinations", MapPinned], ["Anggota", "/admin/members", Users], ["Absensi Harian", "/admin/attendance", CalendarCheck], ["Kegiatan/Agenda", "/admin/meetings", Building2], ["Galeri", "/admin/gallery", Images], ["Dokumentasi", "/admin/documents", FileText], ["Transportasi", "/admin/transportation", Bus], ["Pengumuman", "/admin/announcements", Megaphone], ["Website Settings", "/admin/settings", Settings2], ["Media Manager", "/admin/media", FolderOpen], ["Kontak", "/admin/contact", Contact]];
